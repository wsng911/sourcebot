...
export const useCode镜像Highlighter = () => {
    return useMemo(() => {
        return tagHighlighter([
            // Keywords (if, for, class, etc.)
            { tag: t.keyword, class: 'text-editor-tag-keyword' },

            // 名称s, identifiers, properties
            { tag: [t.name, t.deleted, t.character, t.property名称, t.macro名称, t.variable名称], class: 'text-editor-tag-name' },

            // Functions and variable definitions
            { tag: [t.function(t.variable名称), t.definition(t.variable名称)], class: 'text-editor-tag-function' },
            { tag: t.local(t.variable名称), class: 'text-editor-tag-variable-local' },

            // Property definitions
            { tag: [t.definition(t.name), t.separator, t.definition(t.property名称)], class: 'text-editor-tag-definition' },

            // Labels
            { tag: [t.label名称], class: 'text-editor-tag-label' },
            ...
            // Types and classes
            { tag: [t.type名称, t.namespace], class: 'text-editor-tag-type' },
            { tag: [t.class名称], class: 'text-editor-tag-tag' },
            ...
            { tag: [t.tag名称], class: 'text-editor-tag-tag' },
            { tag: [t.attribute名称], class: 'text-editor-tag-attribute' },
            ...
            // Atoms and booleans
            { tag: [t.atom, t.bool, t.special(t.variable名称)], class: 'text-editor-tag-atom' },
