...
function InputGroup({ class名称, ...props }: React.ComponentProps<"div">) {
  return (
    <div
...
const inputGroup添加onVariants = cva(
...
function InputGroup添加on({
  class名称,
  align = "inline-start",
  ...props
}: React.ComponentProps<"div"> & VariantProps<typeof inputGroup添加onVariants>) {
  return (
    <div
      role="group"
      data-slot="input-group-addon"
      data-align={align}
      class名称={cn(inputGroup添加onVariants({ align }), class名称)}
      onClick={(e) => {
...
function InputGroupButton({
  ...
  return (
    <Button
      ...
      data-size={size}
      variant={variant}
      class名称={cn(inputGroupButtonVariants({ size }), class名称)}
      {...props}
    />
  )
}

function InputGroupText({ class名称, ...props }: React.ComponentProps<"span">) {
  return (
    <span
      class名称={cn(
