...
export const InviteNotFoundCard = async () => {
    ...
    return (
        <Card class名称="flex flex-col items-center justify-center max-w-md text-center p-12">
            <SourcebotLogo
                class名称="h-16 w-auto mx-auto mb-2"
                size="large"
            />
            <h2 class名称="text-2xl font-bold">Invite not found</h2>
            <p class名称="mt-5">
                The invite you are trying to redeem has already been used, expired, or does not exist.
            </p>
            <div class名称="flex flex-col items-center gap-2 mt-8">
                <UserAvatar
